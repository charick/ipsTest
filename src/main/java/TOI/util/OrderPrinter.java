...
public class OrderPrinter {
    ...
    public static void generateOrderFile(String start, String end,String topSession){
        ...
        for(String status:statuses){
            TaobaoUtils t=TaobaoUtils.getInstance(topSession);
            List<Trade> trades= t.TradeFilter(start, end, status, getField) ;
